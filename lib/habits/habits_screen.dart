...
class _HabitsScreenState extends State<HabitsScreen> {
  ...
  void showRestoreDialog(BuildContext context) {
    AwesomeDialog(
      ...
      title: "Notifications",
      desc: "Habit_Tracking needs permission to send notifications to work properly.",
      btnOkText: "Allow",
