...
import 'package:Habit_Tracking/model/settings_data.dart';
import 'package:Habit_Tracking/notifications.dart';
import 'package:Habit_Tracking/themes.dart';
...
class SettingsManager extends ChangeNotifier {
  ...
  void saveData() async {
    ...
    prefs.setString('Habit_Tracking_settings', jsonEncode(_settingsData));
  }

  Future<void> loadData() async {
    final SharedPreferences prefs = await _prefs;
    String? json = prefs.getString('Habit_Tracking_settings');
    if (json != null) {
  ...
  ThemeData get getDark {
    if (_settingsData.theme != Themes.light) {
      return Habit_TrackingTheme.darkTheme;
    } else {
      return Habit_TrackingTheme.lightTheme;
    }
  }
